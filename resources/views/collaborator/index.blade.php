...
@section('content')
    ...
    <a href="{{ route('collaborator.create') }}" class="btn btn-cst btn-lg shadow" role="button" aria-pressed="true">
            ...
            @foreach ($collaborators as $collaborator)
                <tr>
                    ...
                    <td class="text-center not-mobile">
                        ...
                        <a class="btn btn-cst" href="" role="button"><i class="far fa-id-card">
                            </i>&nbspDetalhes
                        </a>
                    </td>
                    <td class="text-center mobile">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <a class="dropdown-item" name="" id="" class="btn" href="#" role="button">
                                    <i class="fas fa-pencil-alt"></i>&nbspEditar
                                </a>
                                <a class="dropdown-item" name="" id="" class="btn" href="#" role="button">
                                    <i class="fas fa-trash-alt"></i>&nbspExcluir
                                </a>
                                <a class="dropdown-item" name="" id="" class="btn" href="show" role="button">
