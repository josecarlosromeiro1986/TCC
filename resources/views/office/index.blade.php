...
@section('content')
    ...
    <div class="center-content">
        ...
        <br />
        {{-- <form class="form form-inline" action="{{ route('office.search') }}" method="POST" style="font-size: 11px;">
            @csrf
            <div>
        ...
        <div class="table-responsive">
            <table class="table table-hover shadow" style="font-size: 13px">
                <thead class="thead-dark">
                    <tr>
                        <th scope="col">Descrição</th>
                        <th scope="col">Acesso</th>
                        <th class="text-center not-mobile" scope="col" width="200">Opções</th>
                    ...
                    @foreach ($offices as $office)
                        <tr>
                            ...
                            <td class="text-center table-buttons not-mobile">
                                <a class="btn btn-info" href="{{ route('office.edit', $office) }}" role="button" style="font-size: 13px">
                                    <i class="fas fa-pencil-alt"></i>&nbspEditar
                                </a>
                                <a class="btn btn-danger text-white" data-toggle="modal" data-target="#delete" role="button" style="font-size: 13px">
